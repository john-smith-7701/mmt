...
my $op = +{     # オペレータ定義
           ...
           ':='   => [sub {$_[0]->setValue('global',$_[1],$_[2])},
                                            50,'R',2],
           '<='  => [sub {cmp_auto($_[1], $_[2],sub {$_[1] <= $_[2]},sub{$_[0] le $_[1]})}, 
                                            60,'L',0],
           '>='  => [sub {cmp_auto($_[1], $_[2],sub {$_[1] >= $_[2]},sub{$_[0] ge $_[1]})},
                                            60,'L',0],
           '>'   => [sub {cmp_auto($_[1], $_[2],sub {$_[1] >  $_[2]},sub{$_[0] gt $_[1]})},
                                            60,'L',0],
           '<'   => [sub {cmp_auto($_[1], $_[2],sub {$_[1] <  $_[2]},sub{$_[0] lt $_[1]})},
                                            60,'L',0],
           '=='  => [sub {cmp_auto($_[1], $_[2],sub {$_[0] == $_[1]},sub{$_[0] eq $_[1]})},
                                            60,'L',0],
           '!='  => [sub {cmp_auto($_[1], $_[2],sub {$_[1] != $_[2]},sub{$_[0] ne $_[1]})},  
                                            60,'L',0],
            '-'  => [sub {$_[1] - $_[2]},   70,'L',0],
           '+'   => [sub {$_[1] + $_[2]},   70,'L',0],
           '*'   => [sub {$_[1] * $_[2]},   80,'L',0],
